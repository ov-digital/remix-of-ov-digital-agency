...
const PAGE_META: Record<string, PageMeta> = {
  "/": {
    title: "OV Digital Agency — digital-продукты для роста продаж бизнеса",
    description: "Создаём сайты, CRM и автоматизацию под ключ — от идеи до запуска. 10+ лет опыта, работаем по всей России. Увеличиваем продажи через digital-продукты.",
  },
  "/about": {
