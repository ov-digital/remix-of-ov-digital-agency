            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  Яркий промо-сайт шоу-проекта с кастомным дизайном и анимациями
                </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Создать запоминающийся промо-сайт для шоу-проекта, который передаст атмосферу 
                  мероприятия и привлечет целевую аудиторию. Сайт должен быть ярким, динамичным 
                  и интерактивным.
                </p>
              </div>
              <div>
                ...
                <p className="text-muted-foreground">
                  Разработали уникальный дизайн с использованием ярких цветов и современных 
                  анимаций. Выбрали WordPress для удобного управления контентом, добавили 
                  интерактивные элементы и оптимизировали для мобильных устройств.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="section-padding bg-primary text-primary-foreground">
          <div className="section-container text-center">
            ...
            <p className="text-primary-foreground/80 mb-6 max-w-xl mx-auto">
              Создадим яркий и запоминающийся сайт для вашего проекта или мероприятия
            </p>
