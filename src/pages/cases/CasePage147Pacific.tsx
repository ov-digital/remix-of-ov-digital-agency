            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Создать современный интернет-магазин для продажи модульных аксессуаров для пикапов и 
                  внедорожников (каркасы безопасности, рейлинги, бамперы). Сайт должен транслировать 
                  премиальное качество продукции Made in USA и обеспечивать удобный конфигуратор товаров.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-4">Решение</h3>
                <p className="text-muted-foreground">
                  Выбрали headless-архитектуру на базе Saleor для высокой производительности и гибкости. 
                  Разработали уникальный дизайн с акцентом на визуализацию продукции, модульный конфигуратор 
                  товаров и интеграцию с американскими платежными системами.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="section-padding bg-card">
          <div className="section-container">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                "Headless eCommerce на Saleor",
                "Каталог модульных аксессуаров",
                "Конфигуратор товаров",
                "Качественная 3D-визуализация",
                "Интеграция с платежами США",
                "Мобильная адаптация",
        ...
        <section className="section-padding bg-primary text-primary-foreground">
          <div className="section-container text-center">
            ...
            <p className="text-primary-foreground/80 mb-6 max-w-xl mx-auto">
              Разработаем современный интернет-магазин на headless-платформе с высокой производительностью
            </p>
