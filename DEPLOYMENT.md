...
*Документация обновлена: 20 января 2026*
...
- [ ] Настроен `VITE_FORM_ENDPOINT` для production
- [ ] Запущена сборка `npm run build` без ошибок
- [ ] Проверены все страницы в браузере
- [ ] Настроен SSL-сертификат на сервере
- [ ] Настроен Nginx для SPA-роутинга

### Рекомендуется
- [ ] Настроена Яндекс.Метрика
- [ ] Настроен API-сервер для форм
- [ ] Настроена капча (SmartCaptcha)
